...
Output: `[type]|key|description|file:line`

Each binding includes the exact file and line number. Pipe to fzf, select, jump directly to the definition.

## fzf Integration

The wrapper script spawns a centered popup with mode switching:
...
<DataGrid
  ...
  data={[
    ...
    { aspect: 'Jump to definition', before: 'Search manually', after: 'Enter → nvim at line' },
